...
namespace PoMMS {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("pommsuserdataDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class pommsuserdataDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected pommsuserdataDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            pommsuserdataDataSet cln = ((pommsuserdataDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "pommsuserdataDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/pommsuserdataDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            pommsuserdataDataSet ds = new pommsuserdataDataSet();
        ...
        public partial class ExpenseDataTable : global::System.Data.TypedTableBase<ExpenseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ExpenseRow AddExpenseRow(int Id, int date, string month, int year, double amount, string category, string description) {
        ...
        public partial class ExpenseRow : global::System.Data.DataRow {
            ...
            public int date {
                get {
                    return ((int)(this[this.tableExpense.dateColumn]));
                }
                set {
            ...
            public string month {
                get {
                    return ((string)(this[this.tableExpense.monthColumn]));
                }
                set {
            ...
            public int year {
                get {
                    return ((int)(this[this.tableExpense.yearColumn]));
                }
                set {
                    this[this.tableExpense.yearColumn] = value;
                }
            }
...
namespace PoMMS.pommsuserdataDataSetTableAdapters {
    ...
    public partial class ExpenseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Expense] WHERE (([Id] = @Original_Id) AND ([date] = @Original_date) AND ([month] = @Original_month) AND ([year] = @Original_year) AND ([amount] = @Original_amount) AND ([category] = @Original_category) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Expense] ([Id], [date], [month], [year], [amount], [category], [description]) VALUES (@Id, @date, @month, @year, @amount, @category, @description);
SELECT Id, date, month, year, amount, category, description FROM Expense WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Expense] SET [Id] = @Id, [date] = @date, [month] = @month, [year] = @year, [amount] = @amount, [category] = @category, [description] = @description WHERE (([Id] = @Original_Id) AND ([date] = @Original_date) AND ([month] = @Original_month) AND ([year] = @Original_year) AND ([amount] = @Original_amount) AND ([category] = @Original_category) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)));
SELECT Id, date, month, year, amount, category, description FROM Expense WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PoMMS.Properties.Settings.Default.pommsuserdataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, date, month, year, amount, category, description FROM dbo.Expense";
        ...
        public virtual int Fill(pommsuserdataDataSet.ExpenseDataTable dataTable) {
        ...
        public virtual pommsuserdataDataSet.ExpenseDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            pommsuserdataDataSet.ExpenseDataTable dataTable = new pommsuserdataDataSet.ExpenseDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pommsuserdataDataSet.ExpenseDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pommsuserdataDataSet dataSet) {
        ...
        public virtual int Delete(int Original_Id, int Original_date, string Original_month, int Original_year, double Original_amount, string Original_category, string Original_description) {
        ...
        public virtual int Insert(int Id, int date, string month, int year, double amount, string category, string description) {
        ...
        public virtual int Update(int Id, int date, string month, int year, double amount, string category, string description, int Original_Id, int Original_date, string Original_month, int Original_year, double Original_amount, string Original_category, string Original_description) {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_date));
            if ((Original_month == null)) {
                throw new global::System.ArgumentNullException("Original_month");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int date, string month, int year, double amount, string category, string description, int Original_Id, int Original_date, string Original_month, int Original_year, double Original_amount, string Original_category, string Original_description) {
            return this.Update(Original_Id, date, month, year, amount, category, description, Original_Id, Original_date, Original_month, Original_year, Original_amount, Original_category, Original_description);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(pommsuserdataDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._expenseTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(pommsuserdataDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._expenseTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(pommsuserdataDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._expenseTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(pommsuserdataDataSet dataSet) {
            if ((dataSet == null)) {
